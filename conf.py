...
BLOG_AUTHOR = "panzer_wy"  # (translatable)
BLOG_TITLE = "信仰は儚き人間の為に"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://panzer_wy.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://panzer_wy.com/"
BLOG_EMAIL = "panzer.wy@gmail.com"
BLOG_DESCRIPTION = "Yi Wang's Personal Blog site. Thanks Nikola! It is based on Nikola python lib."  # (translatable)
